...
const nameLine2 = "Farih Ayu Mukhoirotin";
const nameLine3 = "Sirojul Umma Rosyihin";
let letterIndex = 0;
...
function createNameText(x, y) {
    ...
    const nameLine3El = document.createElement("div");
    nameLine3El.classList.add("name-line");
    nameLine3El.textContent = nameLine3;

    nameContainer.appendChild(nameLine1El);
    nameContainer.appendChild(nameLine2El);
    nameContainer.appendChild(nameLine3El);
